...
c.push('"');return c;default:c.push(String(a));return c}}};if(typeof Crosshair!="undefined"){Crosshair=undefined
}var Crosshair={};Crosshair.oBoxes={oTop:{sBackgroundColour:"black",fOpacity:1},oRight:{sBackgroundColour:"black",fOpacity:1},oBottom:{sBackgroundColour:"black",fOpacity:1},oLeft:{sBackgroundColour:"black",fOpacity:1},iZIndex:32203};
Crosshair.iCursorSpacing=15;Crosshair.fnDisable=function(){document.body.removeChild(this.nTop);
document.body.removeChild(this.nBottom);document.body.removeChild(this.nLeft);document.body.removeChild(this.nRight);
document.body.removeChild(this.nInfo);jsCore.removeListener({sLabel:"CHEvent"})};
Crosshair.fnClose=function(){this.fnDisable();if(typeof Design!="undefined"){document.getElementById("CrosshairSwitch").className="level2";
Design.oState.bCrosshair=false;Design.fnSaveState()}Crosshair=undefined};Crosshair.fnEnable=function(){this.iBodyHeight=document.body.offsetHeight;
...
this.nTop=DesignCore.fnCreateBox({sTop:0,sLeft:0,sHeight:"1px",sWidth:"1px",sBackgroundColour:this.oBoxes.oTop.sBackgroundColour,fOpacity:this.oBoxes.oTop.fOpacity,iZIndex:this.oBoxes.iZIndex});
this.nBottom=this.nTop.cloneNode(false);this.nLeft=this.nTop.cloneNode(false);this.nRight=this.nTop.cloneNode(false);
this.nInfo=DesignCore.fnCreateBox({sId:"CH_info",sTop:0,sLeft:0,sHeight:"10px",sWidth:"100px",sPadding:"5px",fOpacity:0.8,iZIndex:32300});
...
document.body.insertBefore(this.nTop,document.body.childNodes[0]);document.body.insertBefore(this.nBottom,document.body.childNodes[0]);
document.body.insertBefore(this.nLeft,document.body.childNodes[0]);document.body.insertBefore(this.nRight,document.body.childNodes[0]);
document.body.insertBefore(this.nInfo,document.body.childNodes[0]);jsCore.addListener({mElement:document,sType:"mousemove",fnCallback:this.fnMouseMove,oObj:this,mScope:true,sLabel:"CHEvent"})
};Crosshair.fnMouseMove=function(a){this.nTop.style.left=DesignCore.fnPageX(a)+"px";
this.nTop.style.height=(DesignCore.fnPageY(a)-this.iCursorSpacing)>0?(DesignCore.fnPageY(a)-this.iCursorSpacing)+"px":"0px";
this.nBottom.style.left=DesignCore.fnPageX(a)+"px";this.nBottom.style.top=(DesignCore.fnPageY(a)+this.iCursorSpacing)+"px";
...
this.nLeft.style.top=DesignCore.fnPageY(a)+"px";this.nLeft.style.width=(DesignCore.fnPageX(a)-this.iCursorSpacing)>0?(DesignCore.fnPageX(a)-this.iCursorSpacing)+"px":"0px";
this.nRight.style.top=DesignCore.fnPageY(a)+"px";this.nRight.style.left=(DesignCore.fnPageX(a)+this.iCursorSpacing)+"px";
...
this.nInfo.innerHTML="x: "+DesignCore.fnPageX(a)+" y: "+DesignCore.fnPageY(a)};Crosshair.fnEnable();
if(document.getElementById("LoadingCrosshair")){document.getElementById("LoadingCrosshair").parentNode.removeChild(document.getElementById("LoadingCrosshair"))
};