 ...
 */
if(typeof RuleLoader!="undefined"&&typeof RuleControl!="undefined"){RuleControl.fnCloseRule()
}else{var RuleLoader={};RuleLoader.bLoadingComplete=false;RuleLoader.fnLoadFile=function(c,d){var a;
...
}}};RuleLoader.fnLoad=function(){if(typeof Rule=="object"&&typeof RuleControl=="object"&&typeof jsCore=="object"){return 0
...
a.style.backgroundColor="#a2392d";a.setAttribute("id","LoadingRule");a.appendChild(document.createTextNode("Loading Rule..."));
document.getElementsByTagName("body")[0].insertBefore(a,document.body.childNodes[0]);
RuleLoader.fnLoadFile("//www.sprymedia.co.uk/design/rule/media/css/rule.css","css");
RuleLoader.fnLoadFile("//www.sprymedia.co.uk/design/rule/media/js/rule-complete.js","js")
};RuleLoader.fnLoad()};