...
#define NS_IDOMKEYEVENT_IID_STR "2e52eb99-670d-469a-b51f-8efee2dd091d"

#define NS_IDOMKEYEVENT_IID \
  {0x2e52eb99, 0x670d, 0x469a, \
...
class NS_NO_VTABLE nsIDOMKeyEvent : public nsIDOMUIEvent {
 public:
  ...
  NS_IMETHOD InitKeyEvent(const nsAString & typeArg, bool canBubbleArg, bool cancelableArg, mozIDOMWindow *viewArg, bool ctrlKeyArg, bool altKeyArg, bool shiftKeyArg, bool metaKeyArg, uint32_t keyCodeArg, uint32_t charCodeArg) = 0;
...
#define NS_DECL_NSIDOMKEYEVENT \
  NS_IMETHOD GetCharCode(uint32_t *aCharCode) override; \
  NS_IMETHOD GetKeyCode(uint32_t *aKeyCode) override; \
  ...
  NS_IMETHOD InitKeyEvent(const nsAString & typeArg, bool canBubbleArg, bool cancelableArg, mozIDOMWindow *viewArg, bool ctrlKeyArg, bool altKeyArg, bool shiftKeyArg, bool metaKeyArg, uint32_t keyCodeArg, uint32_t charCodeArg) override; \
  NS_IMETHOD GetModifierState(const nsAString & keyArg, bool *_retval) override; \
  NS_IMETHOD GetLocation(uint32_t *aLocation) override; \
  NS_IMETHOD GetRepeat(bool *aRepeat) override; \
  NS_IMETHOD GetKey(nsAString & aKey) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIDOMKEYEVENT \
  ...
  nsresult InitKeyEvent(const nsAString & typeArg, bool canBubbleArg, bool cancelableArg, mozIDOMWindow *viewArg, bool ctrlKeyArg, bool altKeyArg, bool shiftKeyArg, bool metaKeyArg, uint32_t keyCodeArg, uint32_t charCodeArg); \
...
#define NS_FORWARD_NSIDOMKEYEVENT(_to) \
  NS_IMETHOD GetCharCode(uint32_t *aCharCode) override { return _to GetCharCode(aCharCode); } \
  NS_IMETHOD GetKeyCode(uint32_t *aKeyCode) override { return _to GetKeyCode(aKeyCode); } \
...
#define NS_FORWARD_SAFE_NSIDOMKEYEVENT(_to) \
  NS_IMETHOD GetCharCode(uint32_t *aCharCode) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCharCode(aCharCode); } \
  NS_IMETHOD GetKeyCode(uint32_t *aKeyCode) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetKeyCode(aKeyCode); } \
  ...
  NS_IMETHOD GetLocation(uint32_t *aLocation) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLocation(aLocation); } \
  NS_IMETHOD GetRepeat(bool *aRepeat) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRepeat(aRepeat); } \
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsDOMKeyEvent, nsIDOMKeyEvent)
...
/* void initKeyEvent (in DOMString typeArg, in boolean canBubbleArg, in boolean cancelableArg, in mozIDOMWindow viewArg, in boolean ctrlKeyArg, in boolean altKeyArg, in boolean shiftKeyArg, in boolean metaKeyArg, in unsigned long keyCodeArg, in unsigned long charCodeArg); */
NS_IMETHODIMP nsDOMKeyEvent::InitKeyEvent(const nsAString & typeArg, bool canBubbleArg, bool cancelableArg, mozIDOMWindow *viewArg, bool ctrlKeyArg, bool altKeyArg, bool shiftKeyArg, bool metaKeyArg, uint32_t keyCodeArg, uint32_t charCodeArg)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* readonly attribute boolean repeat; */
NS_IMETHODIMP nsDOMKeyEvent::GetRepeat(bool *aRepeat)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
